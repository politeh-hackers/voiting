document.addEventListener("DOMContentLoaded", function () {
    document.querySelectorAll(".appealPage_photos-container").forEach(function (container) {
        var photoContainer = container.querySelector(".appealPage_photos");
        var leftBtn = container.querySelector(".leftPage-btn");
        var rightBtn = container.querySelector(".rightPage-btn");
        if (!photoContainer || !leftBtn || !rightBtn)
            return;
        var photos = photoContainer.querySelectorAll(".appealPage_photo");
