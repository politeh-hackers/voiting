...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Actual',
            fields=[
                ('basic_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='pages.basic')),
                ('header', models.CharField(max_length=200)),
            ...
            bases=('pages.basic', models.Model),
        ),
        migrations.CreateModel(
            name='Appeal',
            fields=[
