...
var m = class _m {
  ...
  constructor({ data: t, config: n, api: r, readOnly: i, block: a }) {
    ...
    this.api = r, this.readOnly = i, this._quotePlaceholder = (n == null ? void 0 : n.quotePlaceholder) || _m.DEFAULT_QUOTE_PLACEHOLDER, this._captionPlaceholder = (n == null ? void 0 : n.captionPlaceholder) || _m.DEFAULT_CAPTION_PLACEHOLDER, this._data = {
      text: t.text || "",
      caption: t.caption || "",
