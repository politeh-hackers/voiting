<template>
  <div class="media-page">
    ...
    <Sidebar v-model:visible="visible" @show="initializeEditor" @hide="handleDialogClose" position="right"
      ...
      <div class="flex flex-col gap-6">
        <div class="flex flex-col">
          ...
          <InputText v-model="post.slug" placeholder="Введите URL страницы" class="w-full" />
        ...
        <div class="flex flex-col">
          ...
          <InputText v-model="post.summary" placeholder="Введите краткое описание" class="w-full" />
    ...
    <Sidebar v-model:visible="visibledt" @show="initializeEditor" @hide="resetForm" position="right"
      :style="{ width: '60rem' }" class="sidebar-edit">
      <template #header>
...
import { PostService, Post } from "../../api/serviceforactual";
